...
export const renderMigration = () => {
  ...
  renderLayout({
    ...
    content: `
      <section class="grid gap-6 lg:grid-cols-2">
        ...
        <article class="panel">
          <h2 class="text-xl font-black text-slate-950 dark:text-white">Status Migrasi 1.8.0</h2>
  ...
  document.querySelector('[data-download-report]').addEventListener('click', () => {
    downloadFile('retralabs-migration-1.8.0-report.json', JSON.stringify(store.getLocalMigrationReport() || store.getLocalMigrationPreview(), null, 2), 'application/json;charset=utf-8');
